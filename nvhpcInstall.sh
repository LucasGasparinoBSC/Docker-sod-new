...
wget https://developer.download.nvidia.com/hpc-sdk/23.3/nvhpc_2023_233_Linux_x86_64_cuda_12.0.tar.gz
...
## Cleanup
rm -rf nvhpc_2023_233_Linux_x86_64_cuda_12.0.tar.gz nvhpc_2023_233_Linux_x86_64_cuda_12.0